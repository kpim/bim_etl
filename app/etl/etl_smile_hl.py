...
PROPERTIES = [p for p in ALL_PROPERTIES if p["template"] == "SMILE HL"]
...
def init():
    print(f"Init properties use Template SMILE HL")
...
def fload():
    print(f"Full load data from properties use Template SMILE HL")
...
def iload():
    print(f"Icremental load data from properties use Template SMILE HL")
...
def fload_history(history_date):
    print(f"Full load historical data from properties use Template SMILE HL")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--property", "-p", help="", default="SRC")
