...
def init():
    print(f"Init properties use Template 02")
...
def fload():
    print(f"Full load data from properties use Template 02")
...
def iload():
    print(f"Icremental load data from properties use Template 02")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--property", "-p", help="", default="Syrena Cruises")
