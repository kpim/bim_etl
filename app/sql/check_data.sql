...
ORDER BY PROPERTY, REPORT_DATE DESC
...
-- du lieu CONSIDERED_DATE bi null
SELECT * 
FROM stg.booking_pace_cpv
...
FROM dbo.booking_pace_report
GROUP BY PROPERTY, REPORT_DATE
ORDER BY REPORT_DATE DESC, PROPERTY

SELECT PROPERTY, REPORT_DATE, COUNT(*) AS NB_ROWS
FROM dbo.booking_pace_report
WHERE PROPERTY IN ('ICHL', 'CPV')
GROUP BY PROPERTY, REPORT_DATE
ORDER BY REPORT_DATE DESC, PROPERTY
...
ORDER BY STAYING_DATE DESC, PROPERTY

SELECT PROPERTY, STAYING, COUNT(*) AS NB_ROWS
FROM dbo.booking_pace_history
GROUP BY PROPERTY, STAYING
ORDER BY STAYING DESC, PROPERTY

SELECT PROPERTY, STAYING, COUNT(*) AS NB_ROWS
FROM dbo.booking_pace_history
WHERE PROPERTY = 'SCSRPQ'
GROUP BY PROPERTY, STAYING
ORDER BY PROPERTY, STAYING DESC

/*
DELETE FROM dbo.booking_pace_history WHERE STAYING >= '2025-08-18'

DELETE FROM dbo.booking_pace_actual WHERE STAYING_DATE >= '2025-08-18'
*/
